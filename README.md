...
- **Data Pipeline + API（個人開発）**  
  自作CSVデータ → ETL→ DB → API  
  [https://github.com/yuu-sosu/ETLpipeline](https://github.com/yuu-sosu/portfolio/tree/main/ETLpipeline/docs)
...
- データ運用：加工・整理、更新ルール/手順書の整備・標準化

## 今後やりたいこと
- 基本情報技術者試験
- BigQuery（DWH設計、コスト/性能）
- dbt（モデリング、tests/docs、CI）

## 背景
名古屋大学 工学部（中退） / 放送大学 情報コース 在籍中 / 42Tokyo / G検定
